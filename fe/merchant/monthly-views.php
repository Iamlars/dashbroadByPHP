      ...
      <div id="main-page">
        ...
        <div id="main" class="account-main">
          ...
          <div class="main-body">
            ...
            <div id="J_table_wrap">
              <table class="border-table monthly-view-table" style="margin-bottom:-1px;" cellspacing="0" border="0" cellpadding="0" width="100%">
                <tr>
                  <td colspan='13'>
                    <h2>2015年1月月报</h2>
                    <span>制表时间：2015-01-31</span>
                  </td>
                </tr>
                <tr>
              ...
              <table class="data-table" cellspacing="0" border="0" cellpadding="0" width="100%">
                <thead>
                  ...
                  <th width="150">收款金额(元)</th>
                  <th width="150">退款金额(元)</th>
                ...
                <?php
                  for ( $counter = 1; $counter <= 12; $counter += 1) {
                    ...
                    echo "<td>王二小</td>";
                    echo "<td>85452158</td>";
                    echo "<td>2015-12-12 14：30</td>";
                    echo "<td>支付宝</td>";
                    echo "<td>85246632@qq.com</td>";
                    echo "<td>85246632@qq.com</td>";
                    echo "<td>111225.00</td>";
                    echo "<td>11.00</td>";
                    echo "<td>11.00</td>";
                    echo "<td>1585241.00</td>";
                    echo "</tr>";
                    }
                 ?>
              ...
              <table style="margin-top:-2px;" class="border-table monthly-view-table" cellspacing="0" border="0" cellpadding="0" width="100%">
                <tr>
                  <td colspan="13" style="text-align:left;">
                    <h3>期末结余</h3>
                    <em>103,522.00元</em>
...
<script src="../dist/js/merchant/monthly-views.js"></script>
</body>
</html>
